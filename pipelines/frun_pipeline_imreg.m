...
function frun_pipeline_imreg( list, reffile, dofissa, force, dostep, tsub, bl_prctile, prctile_thr, pfactivet_thr )
...
params = neuroSEE_setparams(...
            ...
            'pfactivet_thr', pfactivet_thr);         % temporal downsampling factor for CaImAn
