...
load('fam1_fam1rev_20181016_m62.mat');
clear data_locn fam1_0909 fam1_0914 fam1_0918 fam1_0922 fam1rev_0957 fam1rev_1007 fam1rev_1011 fam1rev_1015 filedir globalmasks
...
%% Variables to change
file = fam1;
clear fam1_0949 fam1_0944
rawspikes = file.spikes;


%% Declare variables
tracktime = file.trackdata.time;
x = file.trackdata.x;
y = file.trackdata.y;
r = file.trackdata.r;
rawphi = file.trackdata.phi;
speed = file.trackdata.speed;
...
for i = 1:size(rawphi,1)
    phi(i,:) = randsample(rawphi(i,:),size(rawphi,2));
end
...
save('fam1_20181016_m62_bootstrapshuffleTimeSpikes_hist.mat');