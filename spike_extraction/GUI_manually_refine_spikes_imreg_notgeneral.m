...
function GUI_manually_refine_spikes_imreg_notgeneral( origspikes, tsG, dtsG, df_f, ddf_f, data_locn, file, reffile, expname, origparams, corr_image, masks )
...
edit_decaytime = uicontrol('Parent',panel_option,'style','edit','Units','pixels',...
    'string',num2str(origparams.spkExtract.decay_time),'Enable','on'); 
...
setappdata(fig_gui,'lam_pr',spk_SNR);
