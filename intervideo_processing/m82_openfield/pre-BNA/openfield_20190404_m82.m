...
filedir = [data_locn 'Data/20190404/Processed'];
...
figure;
subplot(241);imagesc(open_1729.red.meanregframe); title('Open 17:29'); caxis([2000 11000]); axis off; axis square;
subplot(242);imagesc(open_1735.red.meanregframe); title('Open 17:35'); caxis([2000 11000]); axis off; axis square;
subplot(243);imagesc(open_1741.red.meanregframe); title('Open 17:41'); caxis([2000 11000]); axis off; axis square;
subplot(244);imagesc(open_1749.red.meanregframe); title('Open 17:49'); caxis([2000 11000]); axis off; axis square;
subplot(245);imagesc(open_1754.red.meanregframe); title('Open 17:54'); caxis([2000 11000]); axis off; axis square;
subplot(246);imagesc(open_1802.red.meanregframe); title('Open 18:02'); caxis([2000 11000]); axis off; axis square;
subplot(247);imagesc(open_1809.red.meanregframe); title('Open 18:09'); caxis([2000 11000]); axis off; axis square;
subplot(248);imagesc(open_1816.red.meanregframe); title('Open 18:16'); caxis([2000 11000]); axis off; axis square;


%% Compare trajectories
figure; 
subplot(251); plot(open_1729.trackdata.x,open_1729.trackdata.y); axis off; title('Open 17:29');
subplot(252); plot(open_1735.trackdata.x,open_1735.trackdata.y); axis off; title('Open 17:35');
subplot(253); plot(open_1741.trackdata.x,open_1741.trackdata.y); axis off; title('Open 17:41');
subplot(254); plot(open_1749.trackdata.x,open_1749.trackdata.y); axis off; title('Open 17:49');
subplot(255); 
    plot(open_1729.trackdata.x,open_1729.trackdata.y); hold on
    plot(open_1735.trackdata.x,open_1735.trackdata.y);
    plot(open_1741.trackdata.x,open_1741.trackdata.y);
    plot(open_1749.trackdata.x,open_1749.trackdata.y); 
    %plot(open_1521.trackdata.x,open_1521.trackdata.y); 
    hold off
    axis off; title('17:29, 17:35, 17:41, 17:49'); 
subplot(256); plot(open_1754.trackdata.x,open_1754.trackdata.y); axis off; title('Open 17:54');
subplot(257); plot(open_1802.trackdata.x,open_1802.trackdata.y); axis off; title('Open 18:02');
subplot(258); plot(open_1809.trackdata.x,open_1809.trackdata.y); axis off; title('Open 18:09');
subplot(259); plot(open_1816.trackdata.x,open_1816.trackdata.y); axis off; title('Open 18:16');
subplot(2,5,10); 
    plot(open_1754.trackdata.x,open_1754.trackdata.y); hold on
    plot(open_1802.trackdata.x,open_1802.trackdata.y);
    plot(open_1809.trackdata.x,open_1809.trackdata.y);
    plot(open_1816.trackdata.x,open_1816.trackdata.y);
        plot(open_1729.trackdata.x,open_1729.trackdata.y); 
        plot(open_1735.trackdata.x,open_1735.trackdata.y);
        plot(open_1741.trackdata.x,open_1741.trackdata.y);
        plot(open_1749.trackdata.x,open_1749.trackdata.y); 
    hold off
    axis off; title('all'); %title('17:54, 18:02, 18:09, 18:16');
