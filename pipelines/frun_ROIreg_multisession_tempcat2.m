...
function frun_ROIreg_multisession_tempcat( list, reffile, bl_prctile_array, pfactivet_thr, activetrials_thr, force, figclose )
if nargin<7, figclose = true; end
if nargin<6, force = false; end
if nargin<5, activetrials_thr = 0.5; end
if nargin<4, pfactivet_thr = 0.05; end
