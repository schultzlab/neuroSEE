function plotpfMaps_2d(activeData_all, pfMap_h_all, pfMap_sm_h_all, infoMap_h_all, pfMap_a_all, infoMap_a_all, ...
                        pcIdx, cell_str, info_str, fname, fclose)
    if nargin<11, fclose = true; end
            ...
            for jj=0:nRow-1
                if (ii*nRow+jj+1) <= Ncells
                    ...
                    if ~isempty(pfMap_a_all)
                        ...
                        title_str = sprintf('%g %s', infoMap_a_all(pcIdx(ii*nRow+jj+1)), info_str); 
                        title(title_str,'fontsize',12);
                    end
                end
            end
