...
ParametersOutput_old1.xypos =  ParametersOutput_old.xypos(Para_ind_left1==1);
ParametersOutput_old1.Pixels = ParametersOutput_old.Pixels(Para_ind_left1==1);
ParametersOutput_old1.xy_all = ParametersOutput_old.xy_all(:,Para_ind_left1==1);
%%
