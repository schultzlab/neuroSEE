...
%% SI (bits/sec)
    ...
    if ~isempty(hist.SIsec.pcIdx)
        ...
        if plotNon_norm
            fname = [sdir 'hist_SIsec/' fname_pref '_spkRaster_PCs'];
    ...
    if ~isempty(hist.SIsec.nonpcIdx)
        ...
        fname = [sdir 'hist_SIsec/' fname_pref '_normspkRaster_nonPCs'];
        plotRaster( Nnonpcs, hist.SIsec.normspkRaster_nonpc, ytick_files, 'Non-PC', fsave, fname, fclose );
        
        if plotNon_norm
            fname = [sdir 'hist_SIsec/' fname_pref '_spkRaster_nonPCs'];
    ...
    if ~isempty(asd.SIsec.pcIdx)
        ...
        if plotNon_norm
            fname = [sdir 'asd_SIsec/' fname_pref '_spkRaster_PCs'];
    ...
    if ~isempty(asd.SIsec.nonpcIdx)
        ...
        fname = [sdir 'asd_SIsec/' fname_pref '_normspkRaster_nonPCs'];
        plotRaster( Nnonpcs, asd.SIsec.normspkRaster_nonpc, ytick_files, 'Non-PC', fsave, fname, fclose );
        
        if plotNon_norm
            fname = [sdir 'asd_SIsec/' fname_pref '_spkRaster_nonPCs'];
...
%% SI (bits/spike)
    ...
    if ~isempty(hist.SIspk.pcIdx)
        ...
        if plotNon_norm
            fname = [sdir 'hist_SIspk/' fname_pref '_spkRaster_PCs'];
    ...
    if ~isempty(hist.SIspk.nonpcIdx)
        ...
        fname = [sdir 'hist_SIspk/' fname_pref '_normspkRaster_nonPCs'];
        plotRaster( Nnonpcs, hist.SIspk.normspkRaster_nonpc, ytick_files, 'Non-PC', fsave, fname, fclose );
        
        if plotNon_norm
            fname = [sdir 'hist_SIspk/' fname_pref '_spkRaster_nonPCs'];
    ...
    if ~isempty(asd.SIspk.pcIdx)
        ...
        if plotNon_norm
            fname = [sdir 'asd_SIspk/' fname_pref '_spkRaster_PCs'];
    ...
    if ~isempty(asd.SIspk.nonpcIdx)
        ...
        fname = [sdir 'asd_SIspk/' fname_pref '_normspkRaster_nonPCs'];
        plotRaster( Nnonpcs, asd.SIspk.normspkRaster_nonpc, ytick_files, 'Non-PC', fsave, fname, fclose );
        
        if plotNon_norm
            fname = [sdir 'asd_SIspk/' fname_pref '_spkRaster_nonPCs'];
