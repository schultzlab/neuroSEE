...
open_1434.tsG = cell_tsG;
open_1434.tsR = cell_tsR;
open_1434.green = green;
open_1434.red = red;
open_1434.masks = masks;
open_1434.mean_imratio = mean_imratio;
clear cell_tsG cell_tsR green red masks mean_imratio

%% Compare red images to see which ones are most similar
figure;
subplot(231);imagesc(open_1406.red.meanregframe); title('Fam1 09:09'); caxis([1900 2800]); axis off; axis square;
subplot(232);imagesc(open_1412.red.meanregframe); title('Fam1 09:14'); caxis([1900 2800]); axis off; axis square;
subplot(233);imagesc(open_1429.red.meanregframe); title('Fam1 09:18'); caxis([1900 2800]); axis off; axis square;
subplot(234);imagesc(open_1434.red.meanregframe); title('Fam1 09:22'); caxis([1900 2800]); axis off; axis square;
% subplot(235);imagesc(fam1_0944.red.meanregframe); title('Fam1 09:44'); caxis([1900 2800]); axis off; axis square;
% subplot(236);imagesc(fam1_0949.red.meanregframe); title('Fam1 09:49'); caxis([1900 2800]); axis off; axis square;


%% Compare trajectories
open_1143.trackdata.x = x;
open_1143.trackdata.y = y;
open_1143.trackdata.r = r;
open_1143.trackdata.phi = phi;
open_1143.trackdata.speed = speed;
clear x y r phi speed TTLout w alpha

figure; 
subplot(271); plot(open_1406.trackdata.x,open_1406.trackdata.y); axis off; title('0220 14:06');
subplot(272); plot(open_1412.trackdata.x,open_1412.trackdata.y); axis off; title('0220 14:12');
subplot(273); plot(open_1429.trackdata.x,open_1429.trackdata.y); axis off; title('0220 14:29');
subplot(274); plot(open_1434.trackdata.x,open_1434.trackdata.y); axis off; title('0220 14:34');
subplot(275); plot(open_1441.trackdata.x,open_1441.trackdata.y); axis off; title('0220 14:41');
subplot(276); plot(open_1505.trackdata.x,open_1505.trackdata.y); axis off; title('0220 15:05');
subplot(277); plot(open_1406.trackdata.x,open_1406.trackdata.y); hold on
    plot(open_1412.trackdata.x,open_1412.trackdata.y);
    plot(open_1038.trackdata.x,open_1038.trackdata.y);
    plot(open_1125.trackdata.x,open_1125.trackdata.y);
    axis off; title('14:06, 14:12, 10:38, 11:25');
subplot(278); plot(open_1038.trackdata.x,open_1038.trackdata.y); axis off; title('0221 10:38');
subplot(279); plot(open_1107.trackdata.x,open_1107.trackdata.y); axis off; title('0221 11:07');
subplot(2,7,10); plot(open_1125.trackdata.x,open_1125.trackdata.y); axis off; title('0222 11:25');
subplot(2,7,11); plot(open_1134.trackdata.x,open_1134.trackdata.y); axis off; title('0222 11:34');
subplot(2,7,12); plot(open_1143.trackdata.x,open_1143.trackdata.y); axis off; title('0222 11:43');
...
for i = 1:size(globalmasks,3)
    ...
    for j = 1:size(fam1_0944_imG,3)
        imG_reshaped = reshape( fam1_0944_imG(:,:,j), 512*512, 1);
        fam1_0944.globaltsG( i, j ) = mean( imG_reshaped(maskind) );
        imR_reshaped = reshape( fam1_0944_imR(:,:,j), 512*512, 1);
...
for i = 1:size(globalmasks,3)
    maskind = find(globalmasks(:,:,i));
    for j = 1:size(fam1_0949_imG,3)
        imG_reshaped = reshape( fam1_0949_imG(:,:,j), 512*512, 1);
        fam1_0949.globaltsG( i, j ) = mean( imG_reshaped(maskind) );
        imR_reshaped = reshape( fam1_0949_imR(:,:,j), 512*512, 1);
