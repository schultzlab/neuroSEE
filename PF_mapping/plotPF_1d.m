function plotPF_1d(occMap, hist, asd, normspkMap_pertrial, ytick_files, fsave, sdir, fname_pref, fclose)
    ...
    for e = 1:Nepochs
        ...
        if fsave
            ...
            if Nepochs == 1
                fname_fig = [sdir fname_pref  '_PFmaps'];
            else
                fname_fig = [sdir fname_pref  '_PFmaps_' num2str(e) 'of' num2str(Nepochs) 'ep'];
            end
    ...
    for e = 1:Nepochs
        ...
        if fsave
            if Nepochs == 1
                fname_fig = [sdir fname_pref '_normPFmaps'];
            else
                fname_fig = [sdir fname_pref '_normPFmaps' num2str(e) 'of' num2str(Nepochs) 'ep'];
            end
            savefig( fh, fname_fig );
            saveas( fh, fname_fig, 'png' );
            if fclose, close( fh ); end
    ...
    for ii=0:Nfig
        ...
        if fsave
            if Ncells/nPlot <= 1
                fname_fig = [sdir fname_pref '_normspk_pertrial_hist'];
            else
                fname_fig = [sdir fname_pref '_normspk_pertrial_hist_' num2str(ii+1)];
            end
            savefig( fh, fname_fig );
            saveas( fh, fname_fig, 'png' );
            if fclose, close( fh ); end
    ...
    if Npcs > 0 
        for ii=0:Nfig
            ...
            if fsave
                if Npcs/nPlot <= 1
                    fname_fig = [sdir fname_pref '_PCs_hist_spk_pertrial'];
                else
                    fname_fig = [sdir fname_pref '_PCs_hist_spk_pertrial' num2str(ii+1)];
                end
                savefig( fh, fname_fig );
                saveas( fh, fname_fig, 'png' );
                if fclose, close( fh ); end
        ...
        for ii=0:Nfig
            ...
            if fsave
                if Npcs/nPlot <= 1
                    fname_fig = [sdir fname_pref '_PCs_hist_normspk_pertrial'];
                else
                    fname_fig = [sdir fname_pref '_PCs_hist_normspk_pertrial' num2str(ii+1)];
                end
                savefig( fh, fname_fig );
                saveas( fh, fname_fig, 'png' );
                if fclose, close( fh ); end
    ...
    if Npcs_asd > 0 
        for ii=0:Nfig
            ...
            if fsave
                if Npcs_asd/nPlot <= 1
                    fname_fig = [sdir fname_pref '_PCs_asd_spk_pertrial'];
                else
                    fname_fig = [sdir fname_pref '_PCs_asd_spk_pertrial' num2str(ii+1)];
                end
                savefig( fh, fname_fig );
                saveas( fh, fname_fig, 'png' );
                if fclose, close( fh ); end
        ...
        for ii=0:Nfig
            ...
            if fsave
                if Npcs_asd/nPlot <= 1
                    fname_fig = [sdir fname_pref '_PCs_asd_normspk_pertrial'];
                else
                    fname_fig = [sdir fname_pref '_PCs_asd_normspk_pertrial' num2str(ii+1)];
                end
                savefig( fh, fname_fig );
                saveas( fh, fname_fig, 'png' );
                if fclose, close( fh ); end
    ...
    if Nepochs > 1
        if Npcs > 0
            ...
            if fsave
                fname_fig = [sdir fname_pref '_remapping_hist'];
                savefig( fh, fname_fig );
                saveas( fh, fname_fig, 'png' );
                if fclose, close( fh ); end
            end
        ...
        if Npcs_asd > 0
            ...
            if fsave
                fname_fig = [sdir fname_pref '_remapping_asd'];
                savefig( fh, fname_fig );
                saveas( fh, fname_fig, 'png' );
                if fclose, close( fh ); end
            end
