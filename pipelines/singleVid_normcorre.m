...
params.nonrigid = NoRMCorreSetParms('d1',size(imG,1),'d2',size(imG,2),'grid_size',[16,16],'mot_uf',4,...
                    'bin_width',200,'max_shift',15,'max_dev',3,'us_fac',50,'init_batch',200,'correct_bidir',1);
[imG, imR, shifts, template, options, col_shift] = normcorre_2ch( imG, imR, params.nonrigid);
...
save(fname_mat_mcorr,'template','options','col_shift');

fname_tif_gr_mcorr = [filedir file '_2P_XYT_green_mcorr_16x16.tif'];
fname_tif_red_mcorr = [filedir file '_2P_XYT_red_mcorr_16x16.tif'];
