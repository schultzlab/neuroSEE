...
nam = '/Volumes/RDS/project/thefarm2/live/CrazyEights/AD_2PCa/GCaMP6s/2018.10.16/2P/20181016_10_11_35_2P/20181016_10_11_35_2P_XYT.raw';
sframe=1;						% user input: first frame to read (optional, default 1)
%num2read=2000;					% user input: how many frames to read   (optional, default until the end)
%tic; Y = read_file(nam,sframe,num2read);toc
tic; Y = read_file(nam,sframe);toc
